...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        // Gradient fill + soft shadow that deepens on hover, so the button
        // reads as a raised surface rather than a flat block.
        default:
          "bg-gradient-primary text-primary-foreground shadow-soft-sm hover:shadow-soft-md hover:brightness-[1.06] active:brightness-95",
        outline:
          "border-border bg-gradient-raised shadow-soft-xs hover:shadow-soft-sm hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-secondary text-secondary-foreground shadow-soft-xs hover:bg-secondary/80 hover:shadow-soft-sm aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
